...
import 'package:proyecto_c2/features/post/presentation/page/post/widget/like_animation_widget.dart';
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  sizeVer(10),
                  Text(
                    "${singlePost.totalLikes} me gusta",
                    style: TextStyle(
                  ...
                  GestureDetector(
                      ...
                      child: Text(
                        "ver todos los ${singlePost.totalComments} comentarios",
